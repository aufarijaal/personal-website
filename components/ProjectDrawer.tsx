...
const ProjectDrawer: React.FC<Props> = ({ project, show, onClose }: Props) => {
  if (!show) return null;
  return (
    <div className="project-detail-drawer-backdrop fixed bottom-0 left-0 custom-animate-slide-up bg-black/10 w-full h-screen outline-none overflow-hidden z-50 flex justify-center items-center">
      <div className="bg-light sm:w-[98%] sm:h-[96%] w-full h-full sm:rounded-xl grid grid-rows-[60%_40%]">
