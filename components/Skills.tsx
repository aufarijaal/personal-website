...
const Skills = () => {
  ...
  // }, []);
  return (
    <section id="skills" className="h-max py-20 bg-light dark:bg-dark flex justify-center">
      <div className="flex flex-col gap-10 max-w-[1200px]">
        ...
        <div className={viewType === "grid" ? "skills-container flex flex-wrap gap-5 items-center justify-center" : "skills-container grid grid-rows-5 sm:grid-cols-2 gap-5 justify-items-center"}>
          ...
          <SkillsItem icon="file-icons:c" skillLevel="Intermediate" viewType={viewType} name="C# (Desktop)" width={130} height={156} src="/csharp-130x156.png" alt="csharp logo" />
