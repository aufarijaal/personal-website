  ...
  return (
    <>
      <section id="landing" className="h-max md:py-32 py-24 flex flex-col lg:gap-20 gap-10">
        ...
        <div id="socials" className="flex gap-5 justify-center flex-wrap px-5">
          ...
          <a href="#" className="social-links cursor-pointer w-16 h-16 bg-primary rounded-full flex items-center justify-center shadow-primary/10 shadow-lg">
            <Icon icon="pepicons:cv" color="white" width="24" height="24" />
          </a>
        </div>
